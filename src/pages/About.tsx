        ...
        <section className="gradient-hero py-20">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground">
              GoKartcom was born from a simple belief: everyone deserves access to truly fresh, 
            ...
            <div className="grid items-center gap-12 lg:grid-cols-2">
              <div>
                ...
                <p className="mt-6 text-muted-foreground">
                  In a world of dark stores and cold storage, we chose a different path. GoKartcom 
            ...
            <div className="grid gap-8 md:grid-cols-2">
              <div className="flex gap-6 rounded-2xl bg-card p-6 shadow-soft">
                ...
                <div>
                  ...
                  <p className="mt-3 text-muted-foreground">
                    "For 20 years, I sold vegetables at the local market. GoKartcom helped me reach 
              ...
              <div className="flex gap-6 rounded-2xl bg-card p-6 shadow-soft">
                ...
                <div>
                  ...
                  <p className="mt-3 text-muted-foreground">
                    "My family has been in the fruit business for three generations. With GoKartcom, 
